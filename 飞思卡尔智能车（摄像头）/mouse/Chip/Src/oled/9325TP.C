...
void LCD_io_init()
{
	gpio_init  (PORTB, 16,  GPO_HDS, 0);
	gpio_init  (PORTB, 17,  GPO_HDS, 0);
	gpio_init  (PORTB, 18,  GPO_HDS, 0);
	gpio_init  (PORTB, 19,  GPO_HDS, 0);
	gpio_init  (PORTB, 20,  GPO_HDS, 0);
	gpio_init  (PORTB, 21,  GPO_HDS, 0);
	gpio_init  (PORTB, 22,  GPO_HDS, 0);
	gpio_init  (PORTB, 23,  GPO_HDS, 0);
        
	gpio_init  (PORTB, 1,  GPO_HDS, 0);  //cs
	gpio_init  (PORTB, 2,  GPO_HDS, 0);  //resT
	gpio_init  (PORTB, 3,  GPO_HDS, 0);  // RD
        gpio_init  (PORTB, 9,  GPO_HDS, 0);  // WR
	gpio_init  (PORTB, 10, GPO_HDS, 0); // rs
        //gpio_init  (PORTC, 11,  GPO_HDS, 0);//
}
